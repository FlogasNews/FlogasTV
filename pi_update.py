...
def get_empty_commodity_chart(target_date):
    ...
    fig.update_layout(
        ...
        xaxis=dict(showticklabels=True, title=None, tickfont=dict(size=14), type='date', range=[start_range, end_range], gridcolor='rgba(255, 255, 255, 0.1)'),
...
def generate_commodity_chart():
    ...
    fig.update_layout(
        ...
        xaxis=dict(showticklabels=True, title=None, tickfont=dict(size=14), type='date', range=[start_range, end_range], showgrid=True, gridcolor='white', dtick=3600000 * 2),
